	...
	>
		...
		>
			...
			<div class="relative z-0 w-[52%] text-right">
				<a href="/login" class="block appearance-none text-xs text-white hover:underline"
					>Forgot password?</a
				>
			</div>
			<button
			...
			{#if form?.notVerified}
				<div
					class="mb-4 rounded-lg bg-red-50 p-4 text-sm text-red-800 dark:bg-red-50 dark:text-red-400"
					role="alert"
				>
